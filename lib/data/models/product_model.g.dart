...
class _$ProductEntity extends ProductEntity {
  ...
  _$ProductEntity._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        categoryId, r'ProductEntity', 'categoryId');
    BuiltValueNullFieldError.checkNotNull(
        subCategoryId, r'ProductEntity', 'subCategoryId');
    BuiltValueNullFieldError.checkNotNull(partNo, r'ProductEntity', 'partNo');
    BuiltValueNullFieldError.checkNotNull(onHand, r'ProductEntity', 'onHand');
    BuiltValueNullFieldError.checkNotNull(upc, r'ProductEntity', 'upc');
    BuiltValueNullFieldError.checkNotNull(
        vendorId, r'ProductEntity', 'vendorId');
    BuiltValueNullFieldError.checkNotNull(sku, r'ProductEntity', 'sku');
    BuiltValueNullFieldError.checkNotNull(
    ...
    try {
      _$result = _$v ??
          new _$ProductEntity._(
              ...
              categoryId: BuiltValueNullFieldError.checkNotNull(categoryId, r'ProductEntity', 'categoryId'),
              subCategoryId: BuiltValueNullFieldError.checkNotNull(subCategoryId, r'ProductEntity', 'subCategoryId'),
              partNo: BuiltValueNullFieldError.checkNotNull(partNo, r'ProductEntity', 'partNo'),
              onHand: BuiltValueNullFieldError.checkNotNull(onHand, r'ProductEntity', 'onHand'),
              upc: BuiltValueNullFieldError.checkNotNull(upc, r'ProductEntity', 'upc'),
              vendorId: BuiltValueNullFieldError.checkNotNull(vendorId, r'ProductEntity', 'vendorId'),
              sku: BuiltValueNullFieldError.checkNotNull(sku, r'ProductEntity', 'sku'),
